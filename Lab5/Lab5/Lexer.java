...
public class Lexer {
    ...
    public Token lexical_scan(BufferedReader br) throws Exception {
        ...
        switch (peek) {
            ...
            case '/':
                ...
                if (peek == '/') {
                    while (peek != '\n') {
                        if (peek == (char) (-1)) {// per qualche motivo non funziona nel while
                            break;
                        }
                        readch(br);
                    }
                    ...
                    throw new Exception("Expected end of comment at line:" + eline);
                } else {
                    return Token.div;
                }
            case ';':
    ...
    public static void main(String[] args) throws Exception {
        Lexer lex = new Lexer();
        String path = "./data.txt"; // il percorso del file da leggere
        try {
